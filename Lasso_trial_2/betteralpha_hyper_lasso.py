...
# ============================================================
# Step 5: Preprocessing (Your Logic)
# ============================================================
...
# ============================================================
# Step 7: Hyperparameter Optimization (IMPROVED)
# ============================================================
# --- NEW: A much wider and more granular grid to find the *true* best alpha ---
param_grid = {
    'regressor__alpha': np.logspace(-3, 2, 50) # Test 50 values from 0.001 to 100
}
# This grid looks like: [0.001, 0.0012, 0.0015, ..., 80.0, 100.0]
# --- END NEW ---

print("Running GridSearchCV with a wider search range...")
...
# ============================================================
# Step 8: Evaluate on Validation Set (Your Logic)
# ============================================================
...
# ============================================================
# Step 9: Predict on Test Data (Your Logic)
# ============================================================
...
print("\nSubmission file 'submission_optimized_tuned.csv' created successfully!")
