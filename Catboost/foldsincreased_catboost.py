...
# --- ⭐️ MODIFIED: Increase folds to isolate outliers ---
N_SPLITS = 10 
...
for fold, (train_index, val_index) in enumerate(kf.split(X_processed_lgbm, y_log, groups=groups)):
    ...
    model_lgbm = LGBMRegressor(
        # --- ⭐️ MODIFIED: Tell model to OPTIMIZE for MAE ---
        objective='regression_l1', # 'regression_l1' is MAE
        n_estimators=5000, 
        learning_rate=0.01, 
        num_leaves=64,
        reg_alpha=0.1, 
...
# ✅ Save safely
output_path = "submission_ensemble_final_10fold_mae.csv" # New name
