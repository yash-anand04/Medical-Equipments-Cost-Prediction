...
# Clip negative costs (your previous fix)
...
lgbm_cat_features = [] 
# --- MODIFIED: Create a 'Hospital_Id_encoded' for grouping ---
# We need the original string Hospital_Id to be encoded for LGBM,
# but we also need a stable integer version for GroupKFold.
...
N_SPLITS = 5
# --- MODIFIED: Use GroupKFold ---
kf = GroupKFold(n_splits=N_SPLITS)
# Create the groups array based on the encoded Hospital_Id
...
# --- MODIFIED: Use kf.split with groups ---
...
# --- END MODIFICATION ---
    ...
    model_lgbm = LGBMRegressor(
        ...
        # --- MODIFIED: Metric is now 'rmse' ---
        # We don't need to set it, 'rmse' is the default for regression.
    )
